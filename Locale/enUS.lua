...
L.TOOLTIP_TRIGGER0 = "Trigger to be activated when a text warning is initially shown for an encounter event."
L.TOOLTIP_TRIGGER1 = "Trigger to be activated when an encounter event on the timeline transitions to a finished (ie. casted, or resolved) state."
L.TOOLTIP_TRIGGER2_FMT = "Trigger to be activated when an encounter event reaches its 'highlight' duration on the timeline (typically, ~%ss before the cast is due)."
